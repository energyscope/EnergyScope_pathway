...
subject to elec_prod_NUCLEAR_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]}   (   F_t ['YEAR_2020','NUCLEAR', h , td] ) = 31700; #from ELIA, versus 34883 from EU
subject to elec_prod_CCGT_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (        F_t ['YEAR_2020','CCGT', h , td] ) = 27800; #from ELIA, versus 27602 from EU
subject to elec_prod_WIND_OFFSHORE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} ( F_t ['YEAR_2020','WIND_OFFSHORE', h , td] ) = 6700; #from ELIA, versus 6826 from EU
subject to elec_prod_WIND_ONSHORE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]}  ( F_t ['YEAR_2020','WIND_ONSHORE' , h , td])  = 4100; #from ELIA, versus 4052 from EU
subject to elec_prod_PV_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2020','PV', h , td] ) = 4300; #from ELIA, versus 4327 from EU
...
subject to elec_prod_HYDRO_RIVER_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2020','HYDRO_RIVER', h , td] ) = 353; #from EU
subject to elec_prod_COAL_US_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (     F_t ['YEAR_2020','COAL_US', h , td] ) = 3236; #As done by GL for 2015
