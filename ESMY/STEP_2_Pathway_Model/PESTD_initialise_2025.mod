...
subject to elec_prod_NUCLEAR_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]}   (   F_t ['YEAR_2025','NUCLEAR', h , td] ) = 34400; #from SPF_Economie, versus 31700 from ELIA, versus 34883 from EU
# subject to elec_prod_CCGT_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (        F_t ['YEAR_2025','CCGT', h , td] ) = 26800; #from SPF_Economie, versus 27 800 from ELIA, versus 27602 from EU
subject to elec_prod_WIND_OFFSHORE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} ( F_t ['YEAR_2025','WIND_OFFSHORE', h , td] ) = 6989; #versus 6700 from ELIA, versus 6826 from EU (SPF_Economie gives 12.8 TWh for all the wind)
subject to elec_prod_WIND_ONSHORE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]}  ( F_t ['YEAR_2025','WIND_ONSHORE' , h , td])  = 5811; #from SPF_Economie, versus 4100 from ELIA, versus 4052 from EU (SPF_Economie gives 12.8 TWh for all the wind)
subject to elec_prod_PV_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','PV', h , td] ) = 5100; #from SPF_Economie, versus 4300 from ELIA, versus 4327 from EU
subject to elec_prod_GEOTHERMAL_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','GEOTHERMAL', h , td] ) = 0; #from EU
subject to elec_prod_HYDRO_RIVER_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','HYDRO_RIVER', h , td] ) = 353; #from EU (confirmed by SPF_Economie, 300)
subject to elec_prod_COAL_US_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (     F_t ['YEAR_2025','COAL_US', h , td] ) = 1900; #from SPF_Economie
subject to elec_prod_COAL_IGCC_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (   F_t ['YEAR_2025','COAL_IGCC', h , td] ) = 0; #As done by GL for 2015
subject to no_elec_import_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (   F_t ['YEAR_2025','ELECTRICITY', h , td] ) = 0; #from SPF_Economie
...
subject to bioethanol_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIOETHANOL', h , td] ) = 1504.9;# 129.4 ktoe = >
subject to biodiesel_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIODIESEL', h , td] ) = 4139.1;# 355.9 ktoe = >

### No import of electrofuels in 2020
subject to no_H2_RE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','H2_RE', h , td] ) = 0.0;
subject to no_GAS_RE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','GAS_RE', h , td] ) = 0.0;
subject to no_AMMONIA_RE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','AMMONIA_RE', h , td] ) = 0.0;
subject to no_METHANOL_RE_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','METHANOL_RE', h , td] ) = 0.0;

### Production of biomethane
# SOURCE: https://www.cng-mobility.ch/wp-content/uploads/2020/09/EBA-Conference-1-Sept-2020-Dirk-Focroul.pdf
subject to biogas_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','BIOMETHANATION', h , td] )  = 2500;
...
subject to ned_prod_METHANOL_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','METHANOL', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"METHANOL"]; #Only import of methanol in 2020 to supply methanol
subject to ned_prod_HVC_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','OIL_TO_HVC', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"HVC"]; #Only Naphtha/LPG cracking to supply HVC
subject to ned_prod_AMMONIA_2020: sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (F_t ['YEAR_2025','HABER_BOSCH', h , td] ) = end_uses_input['YEAR_2025',"NON_ENERGY"] * share_ned ['YEAR_2025',"AMMONIA"]; #Only Haber-Bosch cracking to supply ammonia
...
fix Share_mobility_public['YEAR_2025']:=0.188;
fix Share_freight_train['YEAR_2025']:=0.101;
fix Share_freight_boat['YEAR_2025']:=0.145;
...
let fmin_perc['YEAR_2025',"CAR_DIESEL"] := 0.479;
let fmin_perc['YEAR_2025',"CAR_GASOLINE"] := 0.485;
let fmin_perc['YEAR_2025',"CAR_HEV"] := 0.03;
let fmin_perc['YEAR_2025',"CAR_NG"] := 0.002;
let fmin_perc['YEAR_2025',"CAR_BEV"] := 0.004;
