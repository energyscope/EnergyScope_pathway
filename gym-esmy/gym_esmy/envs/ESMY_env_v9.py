...
class EsmyV9(gym.Env):
    ...
    def __init__(self,**kwargs):
        ...
        if 'n_batch_done' in kwargs:
            self.n_batch_done = kwargs['n_batch_done']
        else:
            self.n_batch_done = 0
...
#------------------------------------------------------------------------------#
    ...
    def step(self,action):
        ...
        skip = self.skip+self.i_epoch+self.n_batch_done*100-1
...
#------------------------------------------------------------------------------#
    ...
    def _get_action_to_ampl(self,action):
        ...
        gwp_limit_0 = action[0]*(123000-3406) + 3406
        gwp_limit_1 = action[1]*(123000-3406) + 3406
