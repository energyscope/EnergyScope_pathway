...
class EsmyMoV21(gym.Env):
    ...
    def __init__(self,**kwargs):
        ...
        #----------------------- Action space ----------------------#
        self.max_allow_fossil = [1] * (len(self.ampl_obj_0.sets['NRE_RESOURCES']))
        self.min_allow_fossil = [0] * (len(self.ampl_obj_0.sets['NRE_RESOURCES']))
...
#------------------------------------------------------------------------------#
    ...
    def _get_action_to_ampl(self,action):
        ...
        allow_foss_res ['ELECTRICITY']          = round(act_foss[0])
        allow_foss_res ['GASOLINE']             = round(act_foss[1])
        allow_foss_res ['DIESEL']               = round(act_foss[2])
        allow_foss_res ['LFO']                  = round(act_foss[3])
        allow_foss_res ['GAS']                  = round(act_foss[4])
        allow_foss_res ['COAL']                 = round(act_foss[5])
        allow_foss_res ['URANIUM']              = round(act_foss[6])
        allow_foss_res ['WASTE']                = round(act_foss[7])
        allow_foss_res ['H2']                   = round(act_foss[8])
        allow_foss_res ['AMMONIA']              = round(act_foss[9])
        allow_foss_res ['METHANOL']             = round(act_foss[10])
