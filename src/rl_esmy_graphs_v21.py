...
def pdf_generator(df_learning, output_path, type_graph = 'act'):
    ...
    labels = ['ELECTRICITY', 'GASOLINE', 'DIESEL', 'LFO', 'GAS', 'COAL', 'URANIUM', 'WASTE', 'H2', 'AMMONIA', 'METHANOL', 'Incent. RE tech']
    clip_dict = {1: [0,1], 2:[0,1], 3:[0,1], 4:[0,1], 5:[0,1], 6:[0,1], 7:[0,1], 8:[0,1], 9:[0,1], 10:[0,1], 11:[0,1], 12:[0,0.5]}
