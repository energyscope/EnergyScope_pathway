...
if test:
    ...
    for batch in range(b0,bf+1):
        ...
        for j in range(ntests):
            ...
            env = gym.make('esmy-v{}'.format(v),out_dir=out_dir_test_batch, v=v,type_of_model=type_of_model, new_step_api=False)
...
if fill_df:
    ...
    df_testing = rl_esmy_stats.updated_status_2050(df_testing)
...
if graph:
    ...
    # sns.scatterplot(finish_success,x='cum_cost',y='cum_gwp',hue='reward')
