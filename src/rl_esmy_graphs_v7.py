...
def pdf_generator(df_learning, output_path, env, type_graph = 'act'):
    ...
    # labels = ['Allow some fossil fuels', 'Allow other fossil fuels', 'Incent. RE tech','Gwp tax']
    labels = ['Allow some fossil fuels', 'Incent. RE tech','Gwp tax']
    n_act = len(labels)
...
def gif(output_path, type_graph, type_distr = 'cum'):
        ...
        elif type_graph in ['ln_act','pdf_act','pdf_act_plus','pdf_cum_gwp', 'pdf_cum_cost','pdf_obs','pdf_rew_act','pdf_rew_cost_gwp']:
