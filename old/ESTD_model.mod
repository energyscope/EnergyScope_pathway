...
var GWP_tech {TECHNOLOGIES, RESOURCES} >= 0; # GWP emissions associated to a technology
...
/*
subject to gwp_tech_calc {i in RESOURCES, j in TECHNOLOGIES}:
	GWP_tech [i,j] = sum {t in PERIODS, h in HOUR_OF_PERIOD [t], td in TYPICAL_DAY_OF_PERIOD [t]} (
		...
		+ sum {j2 in STORAGE_TECH} ( Storage_out [j, l, h, td] - Storage_in [j, l, h, td] )) #The total share of technologies
		); # EUD is missing :/...
*/
